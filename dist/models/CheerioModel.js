...
class Cheerio {
    ...
    getNextPageLink() {
        const selector = "a.s-pagination-item.s-pagination-next.s-pagination-button.s-pagination-separator";
    ...
    getItemCondition() {
        ...
        const selector = "#renewedSingleOfferCaption_feature_div, #renewedAccordionCaption_feature_div";
        let condition = "new";
