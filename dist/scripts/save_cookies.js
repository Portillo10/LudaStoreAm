...
(async () => {
    ...
    const ubiSelector = "div.glow-toaster-footer.span.a-button.a-spacing-top-base.a-button-primary glow-toaster-button.glow-toaster-button-submit input.a-button-input";
    const captchaSelector = "form div.a-row.a-spacing-large div.a-box div.a-box-inner div.a-row.a-text-center img";
    ...
    try {
        ...
        await (0, inputHelper_1.input)("presione cualquier tecla cuando haya acabado.");
        await newContext.storageState({ path: "data/state.json" });
        await newPage.close();
        await newContext.close();
        await browser.close();
        const newCookies = (await (0, jsonHelper_1.readJSON)("data/state.json"))["cookies"];
        await (0, jsonHelper_1.writeJSON)("data/cookies.json", newCookies);
    }
    catch (error) {
        console.log(error);
    }
